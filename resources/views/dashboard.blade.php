        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                <form class="mb-4" action="{{route('question.store')}}" method="post">
                    @csrf
                    <label for="question" class="block text-sm font-medium text-gray-900 dark:text-white">Your message</label>
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="reset" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Cancel</button>
